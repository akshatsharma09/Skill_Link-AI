...
import { register, login, getProfile, updateProfile, forgotPassword, resetPassword, googleAuth } from '../controllers/authController.js';
...
// router.post('/google', googleAuth); // Disabled until Firebase is properly configured
